        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required name="title" id="title" value="{{ old('title') }}" class="form-control" placeholder="عنوان الخبر">
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <textarea required rows="6" name="text" id="text" class="form-control" placeholder="وصف  الخبر">{{ old('text') }}</textarea>
                    @error('text')
                        <p class="m-0 text-danger">{{ $message }}</p>
                    @enderror
                </div>
