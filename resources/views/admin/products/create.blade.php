        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="1" required name="price" id="price" value="{{ old('price') }}" class="form-control" placeholder="سعر المنتج">
                    @error('price')
                        <p class="m-0 text-danger">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="discount_price" id="discount_price" value="{{ old('discount_price') }}" class="form-control" placeholder="سعر المنتج بعد الخصم">
