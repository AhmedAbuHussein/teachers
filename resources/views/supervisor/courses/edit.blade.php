...
<li class="breadcrumb-item"> 
    <a href="{{ route('supervisor.courses.index') }}">المواد</a> 
</li>
...
<div class="container-fluid">
    <form action="{{ route('supervisor.courses.update', $course->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select required name="level_id" id="level_id" class="form-control">
                        ...
                        <option {{ old('level_id', $course->level_id) == $item->id ? 'selected': '' }} value="{{ $item->id }}">{{ $item->title }}</option>
                        @endforeach
