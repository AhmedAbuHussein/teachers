...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6 mr-auto ml-auto">
                <form action="{{ route('supervisor.posts.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select required name="type" id="type" class="form-control">
                            ...
                            <option {{ old('type') == 'image' ? 'selected': '' }} value="image">صورة</option>
                            <option {{ old('type') == 'video' ? 'selected': '' }} value="video">فيديوا</option>
                        </select>
                        @error('type')
                            <p class="m-0 text-danger">{{ $message }}</p>
                        @enderror
